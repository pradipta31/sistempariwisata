...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Edit Kunjungan Wisata</h3> </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="data-kunjungan-wisata.php">Kunjungan Wisata</a></li>
                <li class="breadcrumb-item active">Edit Kunjungan WIsata</li>
            </ol>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card card-outline-primary">
                    <div class="card-body">
                        <form action="proses-edit-kunjungan.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id_kunjungan" value="<?php echo $rowss['id_kunjungan']; ?>">
                            <div class="form-body">
