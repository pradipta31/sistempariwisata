...
<br>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="mb-4">Daftar Seluruh Tempat Wisata di Bali</h2>
          </div>
        </div>
              ...
              <div class="col-md-4">
                <a href="javascript:void(0)" class="blog-entry element-animate" data-animate-effect="fadeIn">
                  ...
                  <div class="blog-content-body">
                    ...
                    <h2><?= $row['nama'];?></h2>
                    <p class="text-justify"><?= substr($row['deskripsi'], 0, 150);?></p>
                    <div class="text-center">
                      <a href="lihat-wisata-login.php?id_wisata=<?php echo "$row[id_wisata]";?>" class="btn btn-primary" style="margin-bottom: 50px">Lihat Wisata</a>
                    </div>
                    <hr>
                  </div>
                </a>
