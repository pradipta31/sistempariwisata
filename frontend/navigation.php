  ...
  <div class="container logo-wrap">
    <div class="row pt-5">
      <div class="col-12 text-center">
        ...
        <h1 class="site-logo"><a href="index.php">SI Wisata</a></h1>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="collapse navbar-collapse" id="navbarMenu">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="semua-wisata.php" style="font-size: 20px">Wisata</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="login.php" style="font-size: 20px">Masuk</a>
          </li>
          <li class="nav-item">
